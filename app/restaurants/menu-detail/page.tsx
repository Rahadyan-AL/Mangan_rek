...
import { ArrowLeft, ShoppingBag, MapPin, Store } from "lucide-react";
          ...
          <div className="space-y-6">
            <Card className="border-border/50 shadow-md bg-card/60 backdrop-blur-xl rounded-[2rem] overflow-hidden">
              <CardHeader className="bg-muted/30 pb-4 border-b border-border/50">
                <CardTitle className="text-lg font-bold">Ringkasan Menu</CardTitle>
              </CardHeader>
            ...
            <Card className="border-border/50 shadow-md bg-card/60 backdrop-blur-xl rounded-[2rem] overflow-hidden">
              ...
              <CardContent className="space-y-3 pt-5">
                <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm transition-all hover:shadow-md h-12 rounded-xl text-base font-medium">
                  <ShoppingBag className="mr-2 h-5 w-5" />
                  Tambah ke Pesanan
                </Button>
                <Button asChild variant="outline" className="w-full h-12 rounded-xl border-primary/30 text-primary hover:bg-primary/5 transition-all">
                  <Link href={`/restaurants/restaurants-detail?restaurantId=${restaurant.id}`}>
                    <Store className="mr-2 h-4 w-4" />
                    Lihat Detail Restoran
                  </Link>
                </Button>
                <Button asChild variant="outline" className="w-full h-12 rounded-xl border-border/50 bg-background/50 backdrop-blur-sm hover:bg-muted/50 transition-all text-foreground">
