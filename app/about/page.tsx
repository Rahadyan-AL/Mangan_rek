export default function AboutPage() {
    ...
    return (
        ...
        >
            <div className="w-full max-w-lg bg-white rounded-xl shadow-lg border border-slate-100 p-8 md:p-10">
                    <h1 className="mb-6 text-3xl font-bold text-[#00458B] text-center">About Us</h1>
