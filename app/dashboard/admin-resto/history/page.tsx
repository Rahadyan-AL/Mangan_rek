  ...
  return (
    <main className="min-h-screen bg-background text-foreground px-6 py-10">
      <div className="mx-auto max-w-4xl">
        <h1 className="text-2xl font-semibold">History Transaksi (Admin Resto)</h1>
        <p className="mt-2 text-sm text-muted-foreground">Riwayat pembayaran terakhir untuk resto Anda.</p>
